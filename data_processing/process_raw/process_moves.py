...
def process_raw_moves(path):
    with open(f'{path}/raw/moves.json', 'r') as f:
        moves = json.load(f, object_pairs_hook=collections.OrderedDict)

    with open(f'{path}/raw/moves_text.json', 'r') as f:
    ...
    with open(f'{path}/processed/moves.json', 'w') as f:
